...
SMK_FILE="BRUseq_UMI.smk"
CONFIG_FILE="BRUseq_UMI_samples.yaml"
...
case "$PIPELINE_TYPE" in
    Bodhi)
        SUBMIT_GLOB="run_BRUseq_UMI_bodhi.sh"
        PROFILES="Bodhi"
        ;;
    Alpine)
        SUBMIT_GLOB="run_BRUseq_UMI_alpine.sh"
        PROFILES="Alpine"
        ;;
    *)
...
rsync -a "$EXTRACT_DIR/BRUseq_UMI/ReadMe.txt" .
