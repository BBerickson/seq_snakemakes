...
SMK_FILE="rmats.smk"
CONFIG_FILE="samples_rMATS.yaml"

PIPELINE_TYPE="$1"

case "$PIPELINE_TYPE" in
    Bodhi)
        SUBMIT_GLOB="run_rMATS_bodhi.sh"
        PROFILES="Bodhi"
        ;;
    Alpine)
        SUBMIT_GLOB="run_rMATS_alpine.sh"
        PROFILES="Alpine"
        ;;
    *)
...
echo "  2. Edit $SUBMIT_GLOB to match DATASET_samples.yaml used"
echo "  3. Run the submit script"
