...
doc <- "Usage: knit_Rmd.R [--help] [--input INPUT] [--output TYPE] [--proj PROJ] [--sample FILE] [--index_map INDEX_MAP] [--index_Sample INDEX_SAMPLE]
...
output <- here(res_dir, paste0(proj,  "_", index_Sample, outname, ".html"))
